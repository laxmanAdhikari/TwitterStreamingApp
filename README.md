...
- Entity Framework flow is setup however for storing Tweet and Author records.
- Unit tests projects are setup for API integration tests[WebApplicationFactory] amd the Controller test [Moq]. Test are just sample and do not have much time to cover all scenarios.
